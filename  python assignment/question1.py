...
mixed_data_types=["sachin",22,5.6,"unmarried","sector-72"]
...
it_companies.append("Priyanshu.Inc")
print (it_companies)#11printing the list
it_companies.insert(5,"Sachin")#12inserting the value at any position in the list.
...
print(front_end)
# this code is done by sachin rollno.(148) cse (5th sem).
# -_- ____________________________________________THE_END________________________________________________________________________________ -_- #